# 📊 Análise de Performance de Vendas com Power BI
...
O projeto foi desenvolvido seguindo uma abordagem estruturada de análise de dados:

### 🔹 1. Entendimento do problema

Definição das principais perguntas de negócio que o dashboard deveria responder.

### 🔹 2. Modelagem de dados

* Organização das tabelas de vendas, produtos, vendedores e metas
* Criação de relacionamentos entre dimensões e fatos
* Estruturação do modelo para análises dinâmicas

### 🔹 3. Criação de métricas (DAX)

* KPIs de faturamento, margem e volume
* Comparação com ano anterior
* Cálculo de atingimento de metas
* Medidas dinâmicas para alternância de análises

### 🔹 4. Desenvolvimento das análises
...
* Desenvolvimento de medidas em **DAX**, especialmente envolvendo contexto de filtro
* Implementação de medidas dinâmicas (SWITCH) para melhorar a usabilidade
* Estruturação de um modelo de dados escalável e organizado
* Construção de análises investigativas (ex: árvore de decomposição)
* Evolução na definição de KPIs relevantes para o negócio
* Melhoria na comunicação de dados, transformando análises em insights claros
